...
resource "aws_autoscaling_group" "example-cluster-1b" {
  name                 = "example-cluster-1ab"
  vpc_zone_identifier  = [aws_subnet.main-public-1.id, aws_subnet.main-public-2.id]
  #launch_configuration = aws_launch_configuration.ecs-example-launchconfig-1.name
  launch_template {
    id      = aws_launch_template.ecs-example-launch-template-1.id
...
resource "aws_autoscaling_group" "example-cluster-2b" {
  name                 = "example-cluster-2ab"
  vpc_zone_identifier  = [aws_subnet.main-public-1.id, aws_subnet.main-public-2.id]
  #launch_configuration = aws_launch_configuration.ecs-example-launchconfig-2.name
  launch_template {
    id      = aws_launch_template.ecs-example-launch-template-2.id
...
resource "aws_ecs_cluster_capacity_providers" "example-cluster-a" {
  cluster_name = aws_ecs_cluster.example-cluster.name

  capacity_providers = [aws_ecs_capacity_provider.example-cluster-a.name,aws_ecs_capacity_provider.example-cluster-b.name,aws_ecs_capacity_provider.example-cluster-c.name,aws_ecs_capacity_provider.example-cluster-d.name]
...
resource "aws_ecs_capacity_provider" "example-cluster-a" {
  name = "example-cluster-aa-cpa"
...
resource "aws_ecs_capacity_provider" "example-cluster-b" {
  name = "example-cluster-bb-cpa"
...
resource "aws_ecs_capacity_provider" "example-cluster-c" {
  name = "example-cluster-aa-cpb"

  auto_scaling_group_provider {
    auto_scaling_group_arn = aws_autoscaling_group.example-cluster-1b.arn
...
resource "aws_ecs_capacity_provider" "example-cluster-d" {
  name = "example-cluster-bb-cpb"

  auto_scaling_group_provider {
    auto_scaling_group_arn = aws_autoscaling_group.example-cluster-2b.arn
